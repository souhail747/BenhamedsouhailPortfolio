...
import edix from "../../projectsphotos/edix.png";
import ecom from "../../projectsphotos/luxe.png";
import chess from "../../projectsphotos/chessmaster.png";
import n8n from "../../projectsphotos/n8nporto.png";
import reservo from "../../projectsphotos/reservo.png";
...
const featuredProjects = [
  ...
  },
  {
    ...
    tech: ["React", "TailwindCSS", "Node.js", "Framer Motion"],
    github: "https://github.com/souhail747/luxe",
    external: "https://luxe-bysouhail.vercel.app/",
    image: ecom,
  },
  {
    id: 1,
    title: "ChessMaster",
    description:
      "A chess learning platform with interactive tutorials, puzzles, and gameplay analysis. Helps players improve skills with move-by-move explanations, board visualizations, and performance tracking.",
    tech: ["React", "TailwindCSS", "JavaScript", "chess.js"],
    github: "https://github.com/souhail747/chessmaster",
    external: "https://chessmaster-bysouhail.vercel.app/",
    image: chess,
  },
  {
    id: 1,
    ...
    description:
      "Portfolio of n8n projects demonstrating automation workflows and integrations that streamline business processes, connect apps, and automate tasks efficiently.",
tech: ["React", "TypeScript", "Tailwind CSS", "Vite", "Framer Motion"],
    github: "",
    external: "https://n8nportfolio-bysouhail.vercel.app/",
    image: n8n,
  },
  {
    id: 1,
    title: "Reservo",
    description:
      "Booking platform that allows users to reserve services and manage appointments online. Includes real-time availability, notifications, and admin dashboard for easy management.",
    tech: ["React", "Node.js", "Express", "TailwindCSS"],
    github: "https://github.com/souhail747/reservo",
    external: "https://reservo-bysouhail.vercel.app/",
    image: reservo,
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-5  mb-24">
          {featuredProjects.map((project, i) => (
            <div
              key={project.title}
              className={`grid md:grid-cols-12 gap-6 mb-24 items-center`}
            >
